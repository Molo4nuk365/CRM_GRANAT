...
- SQL Server (база данных) 2022 года
- JWT (аутентификация)
...
## Ошибка
Заказы фиксируются из API в SQL Server , но с SQL Server на панель не фиксируется в ролях на панели:admin,manager,jeweler,client
